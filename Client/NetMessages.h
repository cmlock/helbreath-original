...
#define DEF_COMMONTYPE_REQ_CONVERTITEM				0x0A27
#define DEF_COMMONTYPE_REQ_CONVERTITEMCONFIRM			0x0A29
...
#define DEF_COMMONTYPE_REQ_CREATESLATE					0x0A61
 ...
 #define DEF_NOTIFY_CANNOTCONVERTITEM				0x0B3A
 #define DEF_NOTIFY_CONVERTITEMPRICE				0x0B3B
 #define DEF_NOTIFY_ITEMCONVERTED					0x0B3C
 ...
 #define DEF_NOTIFY_CHANGEPLAYMODE					0x0BA9 // Snoopy: renamed to match the server // Play mode has been changed.
 #define DEF_NOTIFY_SPAWNEVENT						0x0BAA // Snoopy: renamed to match the server
 ...
 #define DEF_NOTIFY_SETTING_FAILED					0x0BB4 // Your stat has been changed. // Unused ???
