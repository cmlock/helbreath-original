...
// Ground-item UI: lazy per-tile item descriptor fetch (verified unused; do not reuse the
// still-colliding 0x0FA314Dx values above for anything new).
#define MSGID_REQUEST_GROUNDITEMINFO			0x0FA314DF
#define MSGID_RESPONSE_GROUNDITEMINFO			0x0FA314E0
